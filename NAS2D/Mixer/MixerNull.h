...
namespace NAS2D
{
	...
	public:
		...
		void fadeInMusic(const Music& music, int loops = Mixer::CONTINUOUS, std::chrono::milliseconds time = std::chrono::milliseconds{Mixer::DEFAULT_FADE_TIME}) override;
		void fadeOutMusic(std::chrono::milliseconds time = std::chrono::milliseconds{Mixer::DEFAULT_FADE_TIME}) override;
