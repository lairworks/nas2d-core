...
// Declare delegate as a class template. It will be specialized later for all number of arguments.
...
// = 
// = MakeDelegate(&x, &X::func) returns a fastdelegate of the type necessary for
// = calling x.func() with the correct number of arguments. This makes it possible to
// = eliminate many typedefs from user code.
// ==================================================================================
