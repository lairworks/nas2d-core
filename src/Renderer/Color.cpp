...
const Color Color::CoolGrey(128, 128, 143);
const Color Color::CoolLightGrey(192, 192, 207);
const Color Color::CoolDarkGrey(64, 64, 79);
const Color Color::WarmGrey(143, 143, 128);
const Color Color::WarmLightGrey(207, 207, 192);
const Color Color::WarmDarkGrey(79, 79, 64);
