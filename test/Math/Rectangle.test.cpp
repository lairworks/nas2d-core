...
TEST(Rectangle, operatorType) {
	EXPECT_EQ((NAS2D::Rectangle<int>{{0, 0}, {1, 1}}), NAS2D::Rectangle<int>(NAS2D::Rectangle<float>{{0.0, 0.0}, {1.0, 1.0}}));
	EXPECT_EQ((NAS2D::Rectangle<int>{{1, 2}, {3, 4}}), NAS2D::Rectangle<int>(NAS2D::Rectangle<float>{{1.0, 2.0}, {3.0, 4.0}}));

	EXPECT_EQ((NAS2D::Rectangle<float>{{0.0, 0.0}, {1.0, 1.0}}), NAS2D::Rectangle<float>(NAS2D::Rectangle<int>{{0, 0}, {1, 1}}));
	EXPECT_EQ((NAS2D::Rectangle<float>{{1.0, 2.0}, {3.0, 4.0}}), NAS2D::Rectangle<float>(NAS2D::Rectangle<int>{{1, 2}, {3, 4}}));
}
